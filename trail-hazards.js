(function(){
  ...
  function installStyles(){
    ...
    const style=document.createElement('style');style.id='ormaHazardStyles';style.textContent=
      '.orma-hazard-stack{display:grid;gap:10px;margin:14px 0 22px}.orma-hazard{padding:15px 17px;border:1px solid #d6934d;border-left:6px solid #b9582e;border-radius:10px;background:#fff6e8;color:#352a22}.orma-hazard.is-extreme{border-left-color:#91352d;background:#fff0ed}.orma-hazard.is-unverified{border-style:dashed;border-left-color:#8a7a63;background:#faf6ee}.orma-hazard strong{display:block;margin-bottom:6px;font-size:15px}.orma-hazard p{margin:0 0 8px;font-size:13px;line-height:1.5}.orma-hazard small{display:block;color:#6b625a;font-size:11px;line-height:1.4}.orma-hazard a{color:inherit;font-weight:800}';
