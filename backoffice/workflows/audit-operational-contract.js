...
async function auditOperationalContract(root=path.resolve(__dirname,'../..'),options={}){
  ...
  const [builder,rules,client,worker,strategy,standard,hosting]=await Promise.all([
    ...
    read(root,'backoffice/OPERATING_STANDARD.md'),read(root,'backoffice/HOSTING.md'),
  ]);
