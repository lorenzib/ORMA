...
The current dictionaries contain 387 matching English and Italian keys.
...
readiness, offline-download, saved-trail, journal, account-error and mobile-nav
states. Those strings must move behind stable keys before I18N-01 can be marked
complete.
