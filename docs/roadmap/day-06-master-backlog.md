...
the complete UX-06 pre-hike readiness, OFF-03/OFF-05 download lifecycle, and
UX-04 canonical recommendation journeys are bilingual as of 2026-08-12.
Saved/journal, account-error and mobile navigation runtime states remain to
migrate. See
