...
This directory contains the raw geographic source used to build DoloPaws
...
```sh
curl --fail --location \
  --user-agent 'DoloPaws-offline-map-builder/1.0 (https://www.dolopaws.com)' \
...
The output is a DoloPaws-designed Produced Work. The source data and output
